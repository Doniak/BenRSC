	...
	<div style="background-color: #1A5321;">
		<div class="container" style="background-color: #E4EBE2;">
			<div class="row">
				...
				<p><h3 align="center" style="color: #32A041;"><b>Faça o seu login para acessar o ambiente Autenticador</b></h3></p>
				<p align="justify">Você irá usar o login enviado pelo docente que solicitou a autenticação dos documentos.</p>
			</div>
		</div>
	</div>

	<div style="background-color: #1A5321;" id="Autentlogin">
		<BR>
		<form action="Autent_loginRX.php" method="post">
		<div class="container" style="background-color: #E4EBE2;">
			<div class="row">
			...
			<div class="row">
				<p align="center"><a href="Autent_cadastro.php"><button type="button" class="btn" style="border-radius: 8px; border: 3px solid #1A5321;; color: white; padding: 16px 30px; font-size: 20px; background-color: #1A5321;">Cadastre-se</button></a></p>
			</div>
		</div>
		</form>
	</div>
