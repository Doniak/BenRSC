		...
		<div class="container" style="background-color: #E4EBE2;">
			...
			<table align='justify' width="100%" style="border: 4px solid #1A5321;">
				<tr align="center" style="border: 4px solid #1A5321;">
					...
					<th align="center" style="color: #1A5321;">Altera<BR>membro</th>
				</tr>
<?php
...
?>
							<tr style="border: 2px solid #1A5321;">
								...
								<td align="center">
									<form action="CPPD_alteramembrocppd_2.php?idCPPD=<?php echo fnEncodeID($idCPPD);?>" method="post">
										...
										<input type="submit" class="btn" value="Alterar" style="border-radius: 8px; border: 3px solid #1A5321;; color: white; padding: 6px 8px; font-size: 15px; background-color: #1A5321;">
									</form>
							</td>
						</tr>
<?php
