...
?>				
	...
	<div style="background-color: #1A5321;" id="selcriterio">
		<BR>
		<form action="Docente_RSC1_DiretD.php?id=<?php echo fnEncodeID($id);?>#criterio" method="post">
		<div class="container" style="background-color: #E4EBE2;">
<?php
			$query = "SELECT criterio FROM TabRSC WHERE nivel='RSCI' AND diretriz='D'";
...
?>
	...
	<div style="background-color: #1A5321;">
		<div class="container" style="background-color: #E4EBE2;">
<?php
			$query = "SELECT * FROM TabRSC WHERE nivel='RSCI' AND diretriz='D'";
			$result = mysqli_query($link, $query); 
?>
			<table align='center'>
				<tr>
