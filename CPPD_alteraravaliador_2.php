...
?>
	<div  style="background-color: #1A5321;">
		<BR>
		<div class="container" style="background-color: #E4EBE2;">
			<form action="CPPD_alteraravaliador_2_rx.php?idCPPD=<?php echo fnEncodeID($idCPPD);?>" method="post">
			<div class="row">
			...
			<div class="row">
				<div class="coluna" align="center">
					<label>IFE</label><br>
					<input required="required" type="text" name="ife" size="35px" value="<?php echo $ife;?>"/><br>
				</div>
				<div class="coluna" align="center">
