	...
	<div  style="background-color: #1A5321;">
		<div class="container" style="background-color: #E4EBE2;">
			<div class="row">
				...
				<h3 align="center" style="color: #1A5321;">Avaliações em andamento</h3>
			</div>
		</div>
	</div>
		...
		<div class="container" style="background-color: #E4EBE2; ">
			...
			<table align='justify' width="100%" style="border: 4px solid #1A5321;">
				<tr align="center" style="border: 2px solid #1A5321;">
					...
					<th align="center" style="color: #1A5321;">Abrir<BR>avaliação</th>
...
?>
							<tr align="center" style="border: 2px solid #1A5321;">
								...
								<td align="center">
									<form action="CE_avaliacaoemandamento2.php?idCE=<?php echo $idCE;?>" method="post">
										<input type="hidden" name="idPedido" value="<?php echo $idPedido;?>"/>
										<input type="hidden" name="siape" value="<?php echo $row['siape'];?>"/>
										<input type="submit" class="btn" value="Abrir" style="border-radius: 8px; border: 2px solid #1A5321;; color: white; background-color: #1A5321;"/>
									</form>
								</td>
								<td align="center">
