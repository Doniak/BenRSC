...
?>				
	...
	<div style="background-color: #1A5321;">
		<div class="container" style="background-color: #E4EBE2;">
			<div class="row">
				<p><h2 align="center">RSC - III</h2></p>
				<p><h3 align="center" style="color: #32A041;"><b>Diretriz G</b></h3></p>
			</div>
		</div>
	</div>
	...
	<div style="background-color: #1A5321;" id="selcriterio">
		<BR>
		<form action="Docente_RSC3_DiretG.php?id=<?php echo fnEncodeID($id);?>#criterio" method="post">
		<div class="container" style="background-color: #E4EBE2;">
<?php
			$query = "SELECT criterio FROM TabRSC WHERE nivel='RSCIII' AND diretriz='G'";
...
?>
	...
	<div style="background-color: #1A5321;">
		<div class="container" style="background-color: #E4EBE2;">
<?php
			$query = "SELECT * FROM TabRSC WHERE nivel='RSCIII' AND diretriz='G'";
			$result = mysqli_query($link, $query); 
?>
			<table align='center'>
				<tr>
