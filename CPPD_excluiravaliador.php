	...
	<div  style="background-color: #1A5321;">
		<div class="container" style="background-color: #E4EBE2;">
			<div class="row">
				...
				<p><h3 align="center" style="color: #1A5321;"><b>Avaliadores de pedidos RSC cadastrados para compor as Comissões Especiais</b></h3></p>
			</div>
		</div>
	</div>
<?php
		...
		<div class="container" style="background-color: #E4EBE2;">
			...
			<table align='justify' width="100%" style="border: 4px solid #1A5321;">
				<tr align="center" style="border: 4px solid #1A5321;">
					...
					<th align="center" style="color: #1A5321;">Excluir<BR>avaliador</th>
				</tr>
<?php
...
?>
						<tr style="border: 2px solid #1A5321;">
							...
							<td align="center">
								<form action="CPPD_excluiravaliador_rx.php?idCPPD=<?php echo fnEncodeID($idCPPD);?>" method="post">
									<input type="hidden" name="idmembro" value="<?php echo $idrow;?>">
									<input type="submit" class="btn" value="Excluir" style="border-radius: 8px; border: 3px solid #1A5321;; color: white; padding: 8px 8px; font-size: 14px; background-color: #1A5321;">
								</form>
							</td>
						</tr>
<?php
